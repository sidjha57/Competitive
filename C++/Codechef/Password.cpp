    ...
    _cin// for fast I/O
     ...
     while(t--){
      ...
      f1 = false, f2 = false, f3 = false;
       if ( n < 10  || !((int)s[0] <= 122 && (int)s[0] >= 97 && (int)s[n-1] <= 122 && (int)s[n-1] >= 97) ) cout << "NO\n";
       else {
           
            f (i,n) { 
                if ((int)s[i] >= 65 && (int)s[i] <= 90) f1 = true;
                if ((int)s[i] >= 48 && (int)s[i] <= 57) f2 = true;
                if ((int)s[i] == 35 || (int)s[i] == 37 || (int)s[i] == 38 || (int)s[i] == 63 || (int)s[i] == 64) f3 = true;
            }
