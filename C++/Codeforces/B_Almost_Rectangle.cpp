...
if(count==1)return 0; else return 1;}} //at max 15812 times for 9 digit long number
 ...
 int main(){
    _cin// for fast I/O
     ...
     ll t,n,i1,i2,i3,i4,j1,j2,j3,j4;
     cin>>t;
     while(t--){
      cin>>n;
      char matrix[n][n],a;
      ...
      if (j1 != j2 && i1 != i2) {
          ...
          ll val = abs(i1-i2);
          if ((j1-val>-1) || (j2-val >-1)) {
              j3 = j1-val,i3=i1;
              j4 = j2-val,i4=i2;
          }
          else if ((j1+val<n) || (j2+val<n)) {
              j3 = j1+val,i3=i1;
              j4 = j2+val,i4=i2;
          }
          else if ((i1-val>-1) || (i2-val >-1)) {
              i3 = i1-val,j3=j1;
              i4 = i2-val,j4=j2;
          }
          else if ((i1+val<n) || (i2+val <n)) {
              i3 = i1+val,j3=j1;
              i4 = i2+val,j4=j2;
          }
